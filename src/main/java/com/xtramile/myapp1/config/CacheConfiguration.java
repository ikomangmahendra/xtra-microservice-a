package com.xtramile.myapp1.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("xtraMicroserviceA");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("xtraMicroserviceA");
        ...
        config.getMapConfigs().put("com.xtramile.myapp1.domain.*", initializeDomainMapConfig(jHipsterProperties));
